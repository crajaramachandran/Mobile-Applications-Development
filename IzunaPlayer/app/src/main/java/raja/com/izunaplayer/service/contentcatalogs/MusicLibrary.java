...
package raja.com.izunaplayer.service.contentcatalogs;
...
import raja.com.izunaplayer.BuildConfig;
import raja.com.izunaplayer.R;
import raja.com.izunaplayer.ui.Song;
import raja.com.izunaplayer.ui.SongsLoader;
...
*/
    ...
    public static List<MediaBrowserCompat.MediaItem> getMediaItems(Context context) {
        ...
        List<Song> songList = SongsLoader.getAllSongs(context);
    ...
    private static void createMediaMetadataCompat(
            ...
            // int albumArtResId,String albumArtResName
            ) {
        music.put(
                mediaId,
...
//                                getAlbumArtUri(albumArtResName))
        ...
        musicFileName.put(mediaId, MediaStore.Audio.Media.EXTERNAL_CONTENT_URI+"/"+mediaId);
    }
}